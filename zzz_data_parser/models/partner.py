...
class Partner:
    ...
    icon_path: str = ""
    """Path to the partner's icon image."""

    gacha_splash_path: str = ""
    """Path to the partner's gacha splash art."""

    camp: str = ""
    """The partner's camp name."""

    camp_ids: List[int] = field(default_factory=list)
    """The partner's camp IDs."""