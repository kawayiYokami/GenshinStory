...
def main():
    ...
    print("Markdown files and catalog index generated successfully!")
    print(f"  - Markdown: {os.path.abspath(MARKDOWN_OUTPUT_DIR)}")
    print(f"  - JSON Index: {os.path.join(JSON_OUTPUT_DIR, 'index.json')}")
    print("Note: Search index will be generated by zzz_generate_catalog_tree.py")
