...
import type { MessageContentPart, Message, Session, AgentInfo, Command } from './agent/types';

// --- Import managers and services from new modules ---
import { AgentService } from './agent/agentService';
import { MessageManagerImpl, type MessageManager } from './agent/messageManager';
import { SessionManagerImpl, type SessionManager } from '@/services/agent/sessionManager';
import { PersistenceManagerImpl, sessionsStore, lastUsedRolesStore, forceClearAgentCache } from './agent/persistence';
